    ...
    var body: some View {
        ...
        VStack{
            ZStack{
                ...
                if !show {
                    CardItem02(namespace: namespace, show: $show, contentText: $contentText)
                        .onTapGesture {
                    ...
                    CardDetailView02(namespace: namespace, show: $show, contentText: $contentText)
                }
...
struct CardView02_preview: PreviewProvider {
